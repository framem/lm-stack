    ...
    categories: [
        ...
        // ── 6. Kleidung ──
        {
            ...
            items: [
                ...
                { front: 'la camiseta', back: 'T-Shirt', partOfSpeech: 'Nomen', exampleSentence: 'Llevo una camiseta blanca.' },
                { front: 'el pantalón', back: 'Hose', partOfSpeech: 'Nomen', exampleSentence: 'Este pantalón es muy cómodo.' },
                { front: 'el vestido', back: 'Kleid', partOfSpeech: 'Nomen', exampleSentence: 'Ella lleva un vestido rojo.' },
                { front: 'la falda', back: 'Rock', partOfSpeech: 'Nomen', exampleSentence: 'La falda es azul y blanca.' },
                { front: 'el sombrero', back: 'Hut', partOfSpeech: 'Nomen', exampleSentence: 'Mi abuelo lleva un sombrero negro.' },
                { front: 'las gafas', back: 'Brille', partOfSpeech: 'Nomen', exampleSentence: 'Necesito mis gafas para leer.' },
                { front: 'el cinturón', back: 'Gürtel', partOfSpeech: 'Nomen', exampleSentence: 'Este cinturón es de cuero.' },
                { front: 'la camisa', back: 'Hemd', partOfSpeech: 'Nomen', exampleSentence: 'Él lleva una camisa blanca para trabajar.' },
                { front: 'el abrigo', back: 'Mantel', partOfSpeech: 'Nomen', exampleSentence: 'En invierno llevo un abrigo largo.' },
                { front: 'las botas', back: 'Stiefel', partOfSpeech: 'Nomen', exampleSentence: 'Necesito botas para la lluvia.' },
                { front: 'los guantes', back: 'Handschuhe', partOfSpeech: 'Nomen', exampleSentence: 'Hace frío, ponte los guantes.' },
                { front: 'el pijama', back: 'Schlafanzug', partOfSpeech: 'Nomen', exampleSentence: 'Me pongo el pijama antes de dormir.' },
            ],
        },
        ...
        // ── 7. Haus & Wohnung ──
        {
            ...
            items: [
                ...
                { front: 'la silla', back: 'Stuhl', partOfSpeech: 'Nomen', exampleSentence: 'Siéntate en la silla, por favor.' },
                { front: 'el sofá', back: 'Sofa', partOfSpeech: 'Nomen', exampleSentence: 'El gato duerme en el sofá.' },
                { front: 'la ventana', back: 'Fenster', partOfSpeech: 'Nomen', exampleSentence: 'Abre la ventana, hace calor.' },
                { front: 'la puerta', back: 'Tür', partOfSpeech: 'Nomen', exampleSentence: 'Cierra la puerta, por favor.' },
                { front: 'el piso', back: 'Wohnung', partOfSpeech: 'Nomen', exampleSentence: 'Vivimos en un piso pequeño.' },
                { front: 'la escalera', back: 'Treppe', partOfSpeech: 'Nomen', exampleSentence: 'Subimos por la escalera.' },
                { front: 'la lámpara', back: 'Lampe', partOfSpeech: 'Nomen', exampleSentence: 'La lámpara está en la mesa.' },
                { front: 'el espejo', back: 'Spiegel', partOfSpeech: 'Nomen', exampleSentence: 'Me miro en el espejo cada mañana.' },
            ],
        },
        ...
        // ── 9. Wetter & Natur ──
        {
            ...
            items: [
                ...
                { front: 'la nieve', back: 'Schnee', partOfSpeech: 'Nomen', exampleSentence: 'La nieve cubre las montañas.' },
                { front: 'la nube', back: 'Wolke', partOfSpeech: 'Nomen', exampleSentence: 'Hay muchas nubes en el cielo.' },
                { front: 'la estrella', back: 'Stern', partOfSpeech: 'Nomen', exampleSentence: 'Por la noche veo las estrellas.' },
                { front: 'la luna', back: 'Mond', partOfSpeech: 'Nomen', exampleSentence: 'La luna brilla en la noche.' },
                ...
                { front: 'el árbol', back: 'Baum', partOfSpeech: 'Nomen', exampleSentence: 'Hay un árbol grande en el jardín.' },
                { front: 'la flor', back: 'Blume', partOfSpeech: 'Nomen', exampleSentence: 'Las flores son muy bonitas.' },
                { front: 'el cielo', back: 'Himmel', partOfSpeech: 'Nomen', exampleSentence: 'El cielo está azul hoy.' },
                { front: 'la montaña', back: 'Berg', partOfSpeech: 'Nomen', exampleSentence: 'Las montañas son muy altas.' },
                { front: 'la playa', back: 'Strand', partOfSpeech: 'Nomen', exampleSentence: 'Vamos a la playa en verano.' },
            ],
        },
        ...
        // ── 19. Schule & Lernen ──
        {
            ...
            grammarTip: {
                ...
                explanation: 'Viele Schulverben sind regelmäßig und folgen den -ar/-er/-ir-Endungen: estudiar → estudio, leer → leo, escribir → escribo. Achte auf den Stammvokalwechsel bei „e → ie": entender → entiendo.',
                examples: ['Yo estudio español todos los días.', 'Ella lee un libro en clase.', 'Nosotros escribimos en el cuaderno.'],
            },
            items: [
                { front: 'el profesor', back: 'der Lehrer', partOfSpeech: 'Nomen', exampleSentence: 'El profesor explica la lección.' },
                { front: 'el alumno', back: 'der Schüler', partOfSpeech: 'Nomen', exampleSentence: 'El alumno hace su tarea.' },
                { front: 'la clase', back: 'die Klasse', partOfSpeech: 'Nomen', exampleSentence: 'La clase empieza a las ocho.' },
                { front: 'el examen', back: 'die Prüfung', partOfSpeech: 'Nomen', exampleSentence: 'Mañana tengo un examen de español.' },
                { front: 'la tarea', back: 'die Hausaufgabe', partOfSpeech: 'Nomen', exampleSentence: 'Tengo que hacer la tarea de matemáticas.' },
                { front: 'el cuaderno', back: 'das Heft', partOfSpeech: 'Nomen', exampleSentence: 'Escribo en mi cuaderno.' },
                { front: 'el lápiz', back: 'der Bleistift', partOfSpeech: 'Nomen', exampleSentence: '¿Me prestas un lápiz?' },
                { front: 'la pizarra', back: 'die Tafel', partOfSpeech: 'Nomen', exampleSentence: 'El profesor escribe en la pizarra.' },
                { front: 'estudiar', back: 'lernen', partOfSpeech: 'Verb', exampleSentence: 'Estudio español todos los días.' },
                { front: 'leer', back: 'lesen', partOfSpeech: 'Verb', exampleSentence: 'Me gusta leer libros en español.' },
                { front: 'escribir', back: 'schreiben', partOfSpeech: 'Verb', exampleSentence: 'Escribo una carta a mi amigo.' },
                { front: 'preguntar', back: 'fragen', partOfSpeech: 'Verb', exampleSentence: 'El alumno pregunta al profesor.' },
                { front: 'responder', back: 'antworten', partOfSpeech: 'Verb', exampleSentence: 'El profesor responde la pregunta.' },
                { front: 'el libro', back: 'das Buch', partOfSpeech: 'Nomen', exampleSentence: 'Necesito el libro de español.' },
                { front: 'la mochila', back: 'der Rucksack', partOfSpeech: 'Nomen', exampleSentence: 'Mi mochila es azul y grande.' },
            ],
        },
        ...
        // ── 20. Im Restaurant ──
        {
            ...
            grammarTip: {
                title: 'Pedir vs. Preguntar — Bestellen vs. Fragen',
                explanation: '„Pedir" bedeutet „um etwas bitten / bestellen": „Pido un café." „Preguntar" bedeutet „eine Frage stellen": „Pregunto al camarero." Pedir hat einen Stammvokalwechsel: e → i (pido, pides, pide).',
                examples: ['Yo pido una ensalada.', '¿Qué quieres pedir?', 'Pregunto al camarero dónde está el baño.'],
            },
            items: [
                { front: 'el menú', back: 'die Speisekarte', partOfSpeech: 'Nomen', exampleSentence: '¿Me puede traer el menú, por favor?' },
                { front: 'el plato', back: 'der Teller', partOfSpeech: 'Nomen', exampleSentence: 'El plato está muy caliente.' },
                { front: 'la cuchara', back: 'der Löffel', partOfSpeech: 'Nomen', exampleSentence: 'Necesito una cuchara para la sopa.' },
                { front: 'el tenedor', back: 'die Gabel', partOfSpeech: 'Nomen', exampleSentence: 'Come la ensalada con el tenedor.' },
                { front: 'el cuchillo', back: 'das Messer', partOfSpeech: 'Nomen', exampleSentence: 'Corto la carne con el cuchillo.' },
                { front: 'el vaso', back: 'das Glas', partOfSpeech: 'Nomen', exampleSentence: 'Quiero un vaso de agua, por favor.' },
                { front: 'el camarero', back: 'der Kellner', partOfSpeech: 'Nomen', exampleSentence: 'El camarero trae la comida.' },
                { front: 'la cuenta', back: 'die Rechnung', partOfSpeech: 'Nomen', exampleSentence: 'La cuenta, por favor.' },
                { front: 'pedir', back: 'bestellen', partOfSpeech: 'Verb', exampleSentence: 'Quiero pedir el pollo con arroz.' },
                { front: 'servir', back: 'servieren', partOfSpeech: 'Verb', exampleSentence: 'El camarero sirve la comida.' },
                { front: 'la mesa', back: 'der Tisch', partOfSpeech: 'Nomen', exampleSentence: '¿Hay una mesa libre para dos?' },
                { front: 'la silla', back: 'der Stuhl', partOfSpeech: 'Nomen', exampleSentence: 'Necesitamos una silla más.' },
                { front: 'el postre', back: 'der Nachtisch', partOfSpeech: 'Nomen', exampleSentence: 'De postre quiero helado.' },
                { front: 'la bebida', back: 'das Getränk', partOfSpeech: 'Nomen', exampleSentence: '¿Qué bebida quieres?' },
                { front: 'la propina', back: 'das Trinkgeld', partOfSpeech: 'Nomen', exampleSentence: 'Dejamos una propina para el camarero.' },
            ],
        },
        ...
        // ── 21. Tagesablauf ──
        {
            ...
            grammarTip: {
                title: 'Reflexive Verben — Me levanto, te duchas',
                explanation: 'Reflexive Verben beschreiben Handlungen, die man an sich selbst ausführt. Das Reflexivpronomen ändert sich: me (ich), te (du), se (er/sie). Beispiel: „levantarse" → „me levanto" (ich stehe auf).',
                examples: ['Me levanto a las siete.', '¿A qué hora te duchas?', 'Ella se acuesta a las diez.'],
            },
            items: [
                { front: 'despertarse', back: 'aufwachen', partOfSpeech: 'Verb', exampleSentence: 'Me despierto a las seis de la mañana.' },
                { front: 'levantarse', back: 'aufstehen', partOfSpeech: 'Verb', exampleSentence: 'Me levanto a las siete.' },
                { front: 'ducharse', back: 'duschen', partOfSpeech: 'Verb', exampleSentence: 'Me ducho todas las mañanas.' },
                { front: 'desayunar', back: 'frühstücken', partOfSpeech: 'Verb', exampleSentence: 'Desayuno pan con mermelada.' },
                { front: 'almorzar', back: 'zu Mittag essen', partOfSpeech: 'Verb', exampleSentence: 'Almorzamos a las dos.' },
                { front: 'cenar', back: 'zu Abend essen', partOfSpeech: 'Verb', exampleSentence: 'Cenamos a las nueve.' },
                { front: 'acostarse', back: 'ins Bett gehen', partOfSpeech: 'Verb', exampleSentence: 'Me acuesto a las diez de la noche.' },
                { front: 'vestirse', back: 'sich anziehen', partOfSpeech: 'Verb', exampleSentence: 'Me visto rápido por la mañana.' },
                { front: 'lavarse', back: 'sich waschen', partOfSpeech: 'Verb', exampleSentence: 'Me lavo las manos antes de comer.' },
                { front: 'temprano', back: 'früh', partOfSpeech: 'Adverb', exampleSentence: 'Me levanto temprano los lunes.' },
                { front: 'tarde', back: 'spät', partOfSpeech: 'Adverb', exampleSentence: 'Hoy llego tarde a clase.' },
                { front: 'rápido', back: 'schnell', partOfSpeech: 'Adverb', exampleSentence: 'Como rápido porque tengo prisa.' },
                { front: 'despacio', back: 'langsam', partOfSpeech: 'Adverb', exampleSentence: 'Habla despacio, por favor.' },
                { front: 'el despertador', back: 'der Wecker', partOfSpeech: 'Nomen', exampleSentence: 'El despertador suena a las seis.' },
            ],
        },
    ],
}
