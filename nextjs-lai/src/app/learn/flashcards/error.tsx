    ...
    return (
        <div className="flex items-center justify-center min-h-[60vh] px-4">
            <div className="text-center max-w-md">
                ...
                <h2 className="text-2xl font-bold mb-2">Karteikarten konnten nicht geladen werden</h2>
                <p className="text-muted-foreground mb-6">
                    Beim Laden der Karteikarten ist ein Fehler aufgetreten. Bitte versuche es erneut.
                </p>
                <button
                    onClick={reset}
