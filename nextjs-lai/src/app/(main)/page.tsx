...
import { FileText, MessageSquare, HelpCircle, Upload, ArrowRight } from 'lucide-react'
...
export default async function DashboardPage() {
    const [documents, sessions, quizzes] = await Promise.all([
        getDocuments(),
        getSessions(),
        getQuizzes(),
    ])
                        ...
                        <CardContent className="flex items-center gap-4 p-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    PDF, DOCX, TXT oder Text einfügen
                                </p>
                            </div>
                        </CardContent>
                    </Card>
