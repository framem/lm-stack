...
type AdminDashboardProps = {
    initialStatus: EmbeddingStatus | null
    initialError?: string | null
}

export default function AdminDashboard({ initialStatus, initialError = null }: AdminDashboardProps) {
    const [status, setStatus] = useState<EmbeddingStatus | null>(initialStatus)
